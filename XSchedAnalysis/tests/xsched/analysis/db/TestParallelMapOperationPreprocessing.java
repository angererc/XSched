...
public class TestParallelMapOperationPreprocessing extends TestCase {
	...
	static {
		...
		try {
			new FillExtensionalDatabase(database, "bin/xsched/analysis/db/ParallelMapOperation.class", cheater);
	...
	public void testFormalsRelation() {
		...
		int i = 0;
		assertTrue("d"+i++, result.contains("<< Application, Lxsched/analysis/db/ParallelMapOperation, <init>()V >, 0, xsched.analysis.db.ParallelMapOperation.<init>()V.v1>"));
		assertTrue("d"+i++, result.contains("<< Application, Lxsched/analysis/db/ParallelMapOperation, <init>()V >, 0, xsched.analysis.db.ParallelMapOperation.<init>()V.v1>"));
		assertTrue("d"+i++, result.contains("<< Application, Lxsched/analysis/db/ParallelMapOperation, process(Ljava/lang/Object;)Ljava/lang/Object; >, 1, xsched.analysis.db.ParallelMapOperation.process(Ljava/lang/Object;)Ljava/lang/Object;.v2>"));
		assertTrue("d"+i++, result.contains("<< Application, Lxsched/analysis/db/ParallelMapOperation, write(Lxsched/Activation;)V >, 0, xsched.analysis.db.ParallelMapOperation.write(Lxsched/Activation;)V.v1>"));
		assertTrue("d"+i++, result.contains("<< Application, Lxsched/analysis/db/ParallelMapOperation, write(Lxsched/Activation;)V >, 1, xsched.analysis.db.ParallelMapOperation.write(Lxsched/Activation;)V.v2>"));
		assertTrue("d"+i++, result.contains("<< Application, Lxsched/analysis/db/ParallelMapOperation, writeToOut(Ljava/util/Vector;)V >, 0, xsched.analysis.db.ParallelMapOperation.writeToOut(Ljava/util/Vector;)V.v1>"));
		assertTrue("d"+i++, result.contains("<< Application, Lxsched/analysis/db/ParallelMapOperation, writeToOut(Ljava/util/Vector;)V >, 1, xsched.analysis.db.ParallelMapOperation.writeToOut(Ljava/util/Vector;)V.v2>"));	
	}
	...
	public void testActualRelation() {
		...
		int i = 0;
		assertTrue("e"+i++, result.contains("<8 = invokevirtual < Application, Ljava/util/Vector, add(Ljava/lang/Object;)Z > 4,6 @8 exception:7, 0, xsched.analysis.db.ParallelMapOperation.write(Lxsched/Activation;)V.v4>"));
		assertTrue("e"+i++, result.contains("<8 = invokevirtual < Application, Ljava/util/Vector, add(Ljava/lang/Object;)Z > 4,6 @8 exception:7, 1, xsched.analysis.db.ParallelMapOperation.write(Lxsched/Activation;)V.v6>"));
		
		//params flow into new Activation(obj, task, params)
		assertTrue("e"+i++, result.contains("<invokespecial < Application, Lxsched/Activation, <init>(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)V > 15,1,16,14 @35 exception:17, 0, xsched.analysis.db.ParallelMapOperation.writeToOut(Ljava/util/Vector;)V.v15>"));
