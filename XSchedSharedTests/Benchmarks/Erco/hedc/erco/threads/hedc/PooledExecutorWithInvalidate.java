...
public class PooledExecutorWithInvalidate {
	...
	this (new SynchronousQueue<Runnable>(), DEFAULT_MAXIMUMPOOLSIZE);
    }
	...
	this(new SynchronousQueue<Runnable>(), maxPoolSize);
    }
    ...
    public PooledExecutorWithInvalidate(BlockingQueue<Runnable> channel) {
    ...
    public PooledExecutorWithInvalidate(BlockingQueue<Runnable> channel, int maxPoolSize) {
	...
	if (waitTime >= 0) 
	    return (Task)(handOff_.poll(waitTime, TimeUnit.MILLISECONDS));
	else 
